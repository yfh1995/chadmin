...
class AdminRightController extends BaseController
{
    ...
    public function actionIndex($id)
    {
        ...
        ->all();
        $controllers = $this->getAllControllerAction();
    ...
    private function rightAction($rightId, $menu_id){
        ...
        $caDatas = AdminActionService::getFields('controller, action', ['controller' => $controller], ['display_order' => 'asc']);
        ...
        return array_values($rightActionData);
    }
